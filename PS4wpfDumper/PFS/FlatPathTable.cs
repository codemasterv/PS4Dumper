...
namespace PS4wpfDumper.PFS
{
    ...
    public class FlatPathTable
    {
        ...
        public static Tuple<FlatPathTable, CollisionResolver> Create(List<FSNode> nodes)
        {
            ...
            if (!collision)
            {
                return System.Tuple.Create(new FlatPathTable(hashMap), (CollisionResolver)null);
            }
            ...
            return System.Tuple.Create(new FlatPathTable(hashMap), new CollisionResolver(colEnts));
        }
