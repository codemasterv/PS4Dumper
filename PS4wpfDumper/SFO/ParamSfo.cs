...
namespace PS4wpfDumper.SFO
{
  public class ParamSfo
  {
      ...
      for (int value = 0; value < numValues; value++)
      {
        ...
        switch (format)
        {
          ...
          case SfoEntryType.Utf8Special:
            ...
            break;
          default:
            throw new System.Exception($"Unknown SFO type: {(ushort)format:X4}");
        }
      }
      return ret;
    }
    ...
    private System.Tuple<int, int> CalcSize()
    {
      ...
      return System.Tuple.Create(dataTableOffset, dataSize + dataTableOffset);
    }
  ...
  public class IntegerValue : Value
  {
    ...
    public int Value;
    public override byte[] ToByteArray() => System.BitConverter.GetBytes(Value);
    public override string ToString()
    {
      return $"0x{Value:x8}";
    }
