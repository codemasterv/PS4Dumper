...
namespace PS4wpfDumper.PKG
{
  ...
  public abstract class Entry
  {
    ...
    public static byte[] Decrypt(byte[] entryBytes, Pkg pkg, MetaEntry meta)
    {
      if(meta.KeyIndex != 3)
      {
        throw new System.Exception("We only have the key for encryption key 3");
      }
  ...
  public class FileEntry : Entry
  {
    ...
    public FileEntry(EntryId id, System.Action<Stream> writer, uint length)
    {
      Id = id;
    ...
    { }
    private System.Action<Stream> Writer;
    public override EntryId Id { get; }
    public override string Name { get; }
  ...
  public class GeneralDigestsEntry : Entry
  {
    ...
    {
            System.Buffer.BlockCopy(value, 0, Digests[flag], 0, 32);
      set_digests |= flag;
    }
