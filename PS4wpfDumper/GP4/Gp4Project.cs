...
namespace PS4wpfDumper.GP4
{
  ...
  public class Gp4Project
  {
    ...
    public static Gp4Project ReadFrom(System.IO.Stream s)
    {
      ...
      if(proj.volume.Package.EntitlementKey == null && (proj.volume.Type == VolumeType.pkg_ps4_ac_data || proj.volume.Type == VolumeType.pkg_ps4_ac_nodata))
      {
    ...
    public void SetType(VolumeType type)
    {
      ...
      switch (type)
      {
        case VolumeType.pkg_ps4_app:
          ...
          volume.Package.StorageType = $@"{MainWindow.PUBTOOLINFO_st_type}";
  ...
  public class Volume
  {
    ...
    public VolumeType Type
    {
      ...
      set => MainWindow.apptype = value.ToString();
    }
